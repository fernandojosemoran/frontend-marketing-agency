...
function Clients() {
  const { isDarkTheme } = useToggleDarkMode();
        ...
        <div className="lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <TransistorLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={150} height={50} />
            </div>
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <MirageLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={200} height={50} />
            </div>
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <TupleLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={200} height={65} />
            </div>
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <LaravelLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={200} height={50} />
            </div>
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <StaticKitLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={140} height={50} />
            </div>
            <div className="relative col-span-1 flex justify-center bg-lm-primary dark:bg-dm-primary py-8 px-8">
              <StatamicLogoIcon fill={isDarkTheme ? "#ffffff" : "#000"} width={200} height={65} />
            </div>
          </div>
        </div>
      </div>
