        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              <button
                type="button"
                className={`bg-gray-200 flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-gray-900/5 transition-colors duration-200 ease-in-out ring-inset focus-visible:outline-2 focus-visible:outline-indigo-600 ${
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className={`transition duration-200 ease-in-out transform rounded-full bg-white ring-1 shadow-xs ring-gray-900/5 size-4 ${
