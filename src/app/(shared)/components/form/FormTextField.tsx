...
import useToggleDarkMode from "../../hooks/useToggleDarkModel";
...
export default function FormTextField(props: IFormTextField) {
  ...
  const searchColor: string = isDarkTheme ? "#FFFFFF" : "#000";
  ...
  return (
    <>
      <label
        className={`hidden lg:visible pointer-events-none transition-transform duration-500 absolute left-0 inset-0 w-24 ${isDarkTheme && styles.focus} flex gap-1 items-center pl-3`}
